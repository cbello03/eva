        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'stretch', md: 'center' }, gap: 2, mb: 5 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: { xs: 'space-between', md: 'flex-end' }, gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <IconButton onClick={handleLanguageClick} sx={{ color: '#94a3b8', bgcolor: '#1e293b', border: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, cursor: 'pointer', p: 0.5, pr: { xs: 1, sm: 2 }, borderRadius: 5, bgcolor: '#1e293b', border: '1px solid rgba(255,255,255,0.05)' }}>
