        ...
        <Grid container spacing={8} alignItems="center">
          <Grid size={{ xs: 12, md: 6 }}>
            <Box sx={{
              ...
              Novedad: ¡EVA 2.0 está disponible! 🚀
            </Box>
            
            <Typography variant="h1" sx={{ color: '#f8fafc', fontWeight: 800, mb: 3, fontSize: { xs: '3rem', md: '4rem' }, lineHeight: 1.1 }}>
              La Siguiente Generación del <span style={{ background: 'linear-gradient(90deg, #6366f1 0%, #ec4899 100%)', WebkitBackgroundClip: 'text', color: 'transparent' }}>Aprendizaje</span>
            </Typography>
            
            <Typography variant="h6" sx={{ color: '#94a3b8', mb: 5, fontWeight: 400, maxWidth: 480, lineHeight: 1.6 }}>
              EVA es un Entorno Virtual de Enseñanza-Aprendizaje premium, diseñado con gamificación extrema para potenciar tu experiencia académica. Da el salto al futuro.
            </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap' }}>
              <Button
                ...
                sx={{
                  py: 1.5, px: 4, borderRadius: 8, fontSize: '1.1rem', fontWeight: 700,
